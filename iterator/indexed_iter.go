...
//func (i *indexedIterator) First_s() bool {
//	if i.err != nil {
//		return false
//	} else if i.Released() {
//		i.err = ErrIterReleased
...
//func (i *indexedIterator) Last_s() bool {
//	if i.err != nil {
//		return false
//	} else if i.Released() {
//		i.err = ErrIterReleased
...
//func (i *indexedIterator) Seek_s(key []byte) bool {
//	if i.err != nil {
//		return false
//	} else if i.Released() {
//		i.err = ErrIterReleased
...
//	}
//
//	if !i.index.Seek_s(key) {
//		i.indexErr()
//		i.clearData()
//		return false
//	}
//	i.setData()
//	if !i.data.Seek_s(key) {
//		if i.dataErr() {
//			return false
//		}
//		i.clearData()
...
//func (i *indexedIterator) Next_s() bool {
//	if i.err != nil {
//		return false
//	} else if i.Released() {
//		i.err = ErrIterReleased
...
//func (i *indexedIterator) Prev_s() bool {
//	if i.err != nil {
//		return false
//	} else if i.Released() {
//		i.err = ErrIterReleased
