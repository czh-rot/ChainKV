...
//func (i *mergedIterator) First_s() bool {
//	if i.err != nil {
//		return false
//	} else if i.dir == dirReleased {
//		i.err = ErrIterReleased
...
//func (i *mergedIterator) Last_s() bool {
//	if i.err != nil {
//		return false
//	} else if i.dir == dirReleased {
//		i.err = ErrIterReleased
...
//func (i *mergedIterator) Seek_s(key []byte) bool {
//	if i.err != nil {
//		return false
//	} else if i.dir == dirReleased {
//		i.err = ErrIterReleased
...
//func (i *mergedIterator) Next_s() bool {
//	if i.dir == dirEOI || i.err != nil {
//		return false
//	} else if i.dir == dirReleased {
//		i.err = ErrIterReleased
...
//func (i *mergedIterator) Prev_s() bool {
//	if i.dir == dirSOI || i.err != nil {
//		return false
//	} else if i.dir == dirReleased {
//		i.err = ErrIterReleased
...
//			seek := iter.Seek(key)
//			switch {
//			case seek && iter.Prev_s(), !seek && iter.Last():
//				i.keys[x] = assertKey(iter.Key())
//			case i.iterErr(iter):
//				return false
//			default:
